...
read
    ...
    bind_profile == local AND profile chosen AND TPRM_DDQ_S2S_TOKEN unset
...
from tprm_ddq.adapters.local.identity import (
    LocalIdentityAdapter,
)
from tprm_ddq.adapters.onprem.identity import (
