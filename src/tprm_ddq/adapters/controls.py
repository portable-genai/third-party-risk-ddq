...
(``DDQ_REVIEW_ROUTING=off``), the container binds :class:`DisabledReviewRouter` instead of
...
what it returns can say what happened: ``routed``, ``failed``, ``off`` or ``not_required``. A
