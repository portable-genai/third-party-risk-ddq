...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    ...
    "contract_terms.CloudContractTermsAdapter.commitments",
    "extraction.CloudExtractionAdapter.extract",
    "generation.CloudGenerationAdapter.draft_followups",
    "generation.CloudGenerationAdapter.draft_memo",
    "generation.CloudGenerationAdapter.normalise_ddq",
    "register_store.CloudRegisterStoreAdapter.get",
    "register_store.CloudRegisterStoreAdapter.list_for_tenant",
    "register_store.CloudRegisterStoreAdapter.upsert",
    "research.CloudAdverseMediaAdapter.search",
)
